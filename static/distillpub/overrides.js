document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelectorAll("d-cite").forEach(function(cite) {
        ...
        cite.shadowRoot.querySelector("style").sheet
            .insertRule("ul li a {color: var(--global-text-color-primary) !important; text-decoration: none;}");
        cite.shadowRoot.querySelector("style").sheet
    ...
    document.querySelectorAll("d-math").forEach(function(math) {
        math.shadowRoot.querySelector("style").sheet
            .insertRule("span .katex {color: var(--global-text-color-primary) !important;}");
    });
})